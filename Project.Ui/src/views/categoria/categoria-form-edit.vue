<template>
    ...
    <form ref="categoria-form-edit" v-on:keyup.enter="executeEdit()" novalidate>
    ...
    export default {
        ...
        methods: {
            ...
            executeEdit() {
                ...
                new Api('categoria').put(this.model).then(data => {
        ...
        mounted() {
            ...
            new Api('categoria/GetById').get({ categoriaId: this.id }).then(_result => {
